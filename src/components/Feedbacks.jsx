...
import { LetterGlitch } from "./canvas";
...
const ToolCard = ({
  ...
  >
    <div className="mt-1 [transform:rotate(-3deg)] magic-border-wrapper">
      <div className="magic-border-content relative rounded-3xl overflow-hidden bg-primary h-[18rem] md:h-[30rem]">
